...
#
# ^(?:explain)? *select *(?:(?!from).)* *from *([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? ?(?: *| +.*);?$
#
# the regex below supports up to 6 joins (by repeating the join part 6 times)
#
select_join_autocomp_pat = re.compile(r"^(?:explain)? *select *(?:(?!from).)* *from *([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? *(?:(?:left|right|inner|outer) +join +([\`\w_]*\.?[\`\w_]*) *(?:(?!right|left|inner|outer).)* +(?:using +\(\w+\)|on +[\w\.]+ *\= *[\w\.]+))? ?(?: *| +.*);?$", re.IGNORECASE)
